...
// We would only want gameplay effects to modify attributes,
// but for testing purposes we can use these macros to access the attributes directly.
...
private:
	...
	void HandleIncomingDamage(const FGameplayEffectProperties& Properties);
};
